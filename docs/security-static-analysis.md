...
The independent follow-up retest of `6fedf40` confirmed R-11, R-14, and R-15 closed, then reported blocking H-5 and M-5. The local v1.4 candidate addresses those findings and adds canonical-pool registry readback, but none of those changes are closed until the auditor retests them. Static analysis is supporting evidence, not an audit, and no mainnet transaction may be signed against any candidate commit.

## Slither review

The v1.4 working tree was scanned on 2026-09-01 with Slither across 56 contracts and 102 detectors. It reported 36 heuristic results. The three-count increase is attributable to the new future-sale timestamp gate, expired-liquidity timestamp gate, and exact accounted-quote balance-delta check. Manual review found no newly identified fund-loss or authority path; the dispositions still require independent confirmation.
