...
- HoodedHero-gated testnet proposal persistence and a fail-closed transaction-preparation endpoint.
...
The bundled testnet manifest fixes supply at 1,000,000,000 HERO and encodes 40% fair launch, 30% game/season rewards, 15% locked liquidity, 10% timelocked DAO, and 5% contributors vesting for 24 months. Its placeholder wallet, URL, content hashes, dates, and media URI must be replaced and independently reviewed before deployment rehearsal.
